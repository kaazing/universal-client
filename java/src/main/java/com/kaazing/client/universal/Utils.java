...
public class Utils {
	 ...
	 * @throws IOException indicates that object cannot be serialized 
	 */
	 ...
	 * @param bytes byte array containing the object
	 * @return Deserialized object
	 * @throws IOException indicates that deserialization cannot be performed due to IO error
	 * @throws ClassNotFoundException indicates that deserialization cannot be performed due to the abscence of suitable class
	 */
