...
public class UniversalClientFactory {
	 ...
	 * @param url URL to Kaazing Gateway
	 * @param login Login to use with Kaazing Gateway
	 * @param password Login to use with Kaazing Gateway
	 * @param errorsListener Callback to handle client errors
	 * @return instance of Universal Client specific to a selected protocol
	 * @throws ClientException indicates an error
	 */
